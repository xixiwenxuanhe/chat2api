...
logger.info("AUTHORIZATION:     " + f"configured ({len(authorization_list)})" if authorization_list else "AUTHORIZATION:     None")
logger.info("ADMIN_KEY:         " + ("configured" if admin_key else "None"))
logger.info("AUTH_KEY:          " + ("configured" if auth_key else "None"))
logger.info("------------------------- Request --------------------------")
logger.info("CHATGPT_BASE_URL:  " + str(chatgpt_base_url_list))
logger.info("PROXY_URL:         " + f"configured ({len(proxy_url_list)})" if proxy_url_list else "PROXY_URL:         None")
logger.info("EXPORT_PROXY_URL:  " + ("configured" if export_proxy_url else "None"))
